...
Seurat 是 R 生态中最常用的单细胞分析框架之一。官方 vignettes 以 PBMC 数据为入口，展示从读取 10x 数据、创建 Seurat object、QC、归一化、特征选择、PCA、邻居图、聚类、UMAP 到 marker gene 的标准流程。
...
<div class="path-grid">
  <a href="/tools/seurat/pbmc-workflow">
    ...
    <span>参考官方 PBMC tutorial，整理 CreateSeuratObject, QC, NormalizeData, PCA, UMAP, clusters, and markers。</span>
  </a>
  <a href="/tools/scanpy/">
    <strong>与 Scanpy 对照</strong>
    <span>把 Seurat object 和 AnnData 对照起来，理解 metadata, reductions, assays, and layers。</span>
  </a>
