...
《詹韦免疫生物学》适合当作免疫学主干教材来读，但网站里的目标不是逐章复述，而是把教材知识重组为单细胞研究者更容易使用的结构：先知道免疫系统由谁组成，再理解它们怎样识别危险、怎样被激活、怎样执行效应功能，最后回到疾病、疫苗、肿瘤和组织微环境。
...
<div class="check-grid">
  ...
  <article>
    <strong>效应</strong>
    <span>吞噬、中和、补体裂解、细胞毒杀伤、巨噬细胞活化、屏障修复等机制共同清除威胁。</span>
  </article>
  <article>
    <strong>调控</strong>
