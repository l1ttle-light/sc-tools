...
<div class="path-grid">
  <a href="/biology/central-dogma-omics">
    ...
    <span>从 DNA、RNA、蛋白质到代谢物，再扩展到微生物群落和多组学整合。</span>
  </a>
  <a href="/biology/sequencing-principles">
    <strong>测序方法与技术原理</strong>
    <span>理解不同测序方法的读出对象、实验偏倚和适合回答的问题。</span>
  </a>
...
<div class="doc-callout important">
  <strong>为什么先放文献背书</strong>
  <p>单细胞结论很容易被图形直觉带偏。这里优先引用经典论文、高影响力综述和技术方法论文，是为了让每个概念都能回到可靠出处。</p>
</div>
