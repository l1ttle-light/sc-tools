...
<div class="doc-callout example">
  ...
  <p>肿瘤样本中，如果某些细胞群同时表现出异常 CNV 信号和特定转录状态，就要区分“细胞类型差异”和“恶性克隆差异”。</p>
</div>
...
单细胞 RNA-seq 进一步把群体平均信号拆到单细胞分辨率，但也带来掉落事件、捕获效率、批次效应和解离偏倚。读 scRNA-seq 结果时要记住：表达量是细胞状态的观测，不是细胞身份的全部。
