...
<div class="home-hero">
  <div>
    <span class="eyebrow">Single Cell Research</span>
    <h1>从生物学问题出发，走到可复现的单细胞分析。</h1>
    <p>这个站点按生物信息学的真实工作顺序组织：先建立生物学坐标系，再选择合适的单细胞工具，最后把分析落成可以复跑、可审阅、可交付的项目。</p>
    <div class="hero-actions">
      <a class="secondary-action" href="/biology/">先读生物学知识</a>
      <a class="secondary-action" href="/practice/raw-matrix-to-report">查看实战模板</a>
    </div>
  </div>
  <div class="cell-loop" aria-label="单细胞研究闭环">
    <span>生物学问题</span>
    <span>组学测量</span>
    <span>数据结构</span>
    <span>质量控制</span>
...
单细胞分析不是从 UMAP 开始的。更稳的路径是：先理解中心法则、组学层级、测序技术和免疫微环境；再学习 Scanpy、AnnData 等工具如何承载这些数据；然后深入算法论文和代码，理解模型为什么这样设计；最后通过固定目录、配置和脚本，把每一步变成可复现工作流。

<div class="path-grid">
  <a href="/biology/">
    <strong>1. 生物学知识</strong>
    <span>从中心法则到基因组、转录组、蛋白组、代谢组、宏基因组、测序原理和免疫微环境。</span>
  </a>
  <a href="/tools/">
    <strong>2. 单细胞相关工具</strong>
    <span>以 AnnData, Scanpy, Seurat, and scvi-tools 为主线，逐步覆盖 CellTypist, Squidpy, scVelo 等工具。</span>
  </a>
  <a href="/algorithms/">
    <strong>3. 算法详解</strong>
    <span>逐篇阅读论文和 GitHub 代码，拆解算法作用、输入输出、模型结构、训练推理和复现要点。</span>
  </a>
  <a href="/practice/">
  ...
  <a href="/references/">
    <strong>参考资料</strong>
    <span>集中收录官方教程、高质量综述、经典论文和实践型资料。</span>
  </a>
</div>
...
<div class="path-grid">
  <a href="/biology/central-dogma-omics">
    <strong>中心法则与组学层级</strong>
    <span>DNA、RNA、蛋白质、代谢物和微生物群落分别回答不同层次的问题。</span>
  </a>
  <a href="/biology/sequencing-principles">
    <strong>测序方法与技术原理</strong>
    <span>bulk RNA-seq、scRNA-seq、ATAC-seq、CITE-seq、空间转录组和多组学技术。</span>
  </a>
  ...
  <a href="/biology/immunology-microenvironment">
    ...
    <span>先天免疫、适应性免疫、免疫细胞谱系、肿瘤免疫微环境和组织生态位。</span>
  </a>
  <a href="/biology/">
    <strong>知识总览</strong>
    <span>把概念、技术和解释路径放到一套知识框架里。</span>
  </a>
</div>
...
这一部分负责回答“模型为什么这样工作”。之后你给我文献时，我会先读论文和补充材料，再查看官方 GitHub 仓库与关键代码路径，最后把算法拆成作用、输入输出、结构图、模块逻辑和复现要点。

<div class="path-grid">
  <a href="/algorithms/">
    <strong>板块说明</strong>
    <span>说明算法详解页面的阅读标准、代码阅读流程和交付格式。</span>
  </a>
  ...
  <a href="/algorithms/template/">
    ...
    <span>包含输入输出文件格式、模型结构、训练推理、代码入口和 Mermaid 示意图模板。</span>
  </a>
</div>

## 实战模拟

实战部分负责回答“如何交付一个别人能复查的项目”。这里的 PBMC 模板和站点教程一一对应，可以直接作为后续真实项目的脚手架。
